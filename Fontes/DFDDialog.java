...
public class DFDDialog extends Dialog
{
    protected static final Dimension areaDesenho = new Dimension(1500,1500);
    protected Diagrama dfd;
    protected Projeto projeto;
    public DFDDialog (Frame parent, Projeto projeto, Diagrama dfd)
    {
        this(parent, "DFD " + dfd.processo.getNomeCompleto(), false);
	...
	public DFDDialog(Frame parent, boolean modal)
	{
		super(parent, modal);
		...
		processoButton = new symantec.itools.awt.ImageButton();
		try {
			processoButton.setImageURL(symantec.itools.net.RelativeURL.getURL("processo.gif"));
		}
		catch (java.net.MalformedURLException error) { }
		catch(java.beans.PropertyVetoException e) { }
		try {
			processoButton.setShowFocus(false);
		}
		catch(java.beans.PropertyVetoException e) { }
		processoButton.setBounds(132,0,44,38);
		toolBarPanel1.add(processoButton);
		...
		entidadeButton.setBounds(176,0,44,38);
		toolBarPanel1.add(entidadeButton);
		depositoButton = new symantec.itools.awt.ImageButton();
		try {
			depositoButton.setImageURL(symantec.itools.net.RelativeURL.getURL("deposito.gif"));
		}
		catch (java.net.MalformedURLException error) { }
		catch(java.beans.PropertyVetoException e) { }
		try {
			depositoButton.setShowFocus(false);
		}
		catch(java.beans.PropertyVetoException e) { }
		depositoButton.setBounds(220,0,44,38);
		toolBarPanel1.add(depositoButton);
		...
		fluxoButton.setBounds(264,0,44,38);
		toolBarPanel1.add(fluxoButton);
		decomporButton = new symantec.itools.awt.ImageButton();
		try {
			decomporButton.setImageURL(symantec.itools.net.RelativeURL.getURL("decompor.gif"));
		}
		catch (java.net.MalformedURLException error) { }
		catch(java.beans.PropertyVetoException e) { }
		try {
			decomporButton.setShowFocus(false);
		}
		catch(java.beans.PropertyVetoException e) { }
		decomporButton.setBounds(308,0,44,38);
		toolBarPanel1.add(decomporButton);
		...
		verificarButton.setBounds(352,0,44,38);
		...
		ajudaButton.setBounds(396,0,44,38);
		...
		processoButton.addActionListener(lSymAction);
		entidadeButton.addActionListener(lSymAction);
		depositoButton.addActionListener(lSymAction);
		fluxoButton.addActionListener(lSymAction);
		decomporButton.addActionListener(lSymAction);
	...
	public DFDDialog(Frame parent, String title, boolean modal)
	{
		this(parent, modal);
		setTitle(title);
	}
	...
	symantec.itools.awt.ImageButton processoButton;
	symantec.itools.awt.ImageButton entidadeButton;
	symantec.itools.awt.ImageButton depositoButton;
	symantec.itools.awt.ImageButton fluxoButton;
	symantec.itools.awt.ImageButton decomporButton;
	...
	class SymWindow extends java.awt.event.WindowAdapter
	{
		public void windowDeactivated(java.awt.event.WindowEvent event)
		{
			...
			if (object == DFDDialog.this)
				DFDDialog_WindowDeactivated(event);
		}
		...
		public void windowActivated(java.awt.event.WindowEvent event)
		{
			Object object = event.getSource();
			if (object == DFDDialog.this)
				DFDDialog_WindowActivated(event);
		}
	...
	class SymAction implements java.awt.event.ActionListener
	{
		public void actionPerformed(java.awt.event.ActionEvent event)
		{
			...
			else if (object == processoButton)
				processoButton_actionPerformed(event);
			else if (object == entidadeButton)
				entidadeButton_actionPerformed(event);
			else if (object == depositoButton)
				depositoButton_actionPerformed(event);
			else if (object == fluxoButton)
				fluxoButton_actionPerformed(event);
			else if (object == decomporButton)
				decomporButton_actionPerformed(event);
	...
	{
		(new VerificarDialog((Frame) this.getParent(), this.dfd)).setVisible(true);
	}

	void editarButton_actionPerformed(java.awt.event.ActionEvent event)
	{
	    dfdCanvas.editar();
        this.setTitle("DFD " + dfd.processo.getNomeCompleto());
	}

	void DFDDialog_WindowActivated(java.awt.event.WindowEvent event)
	{
        this.setTitle("DFD " + dfd.processo.getNomeCompleto());
        dfdCanvas.repaint();
	}
	...
	void DFDDialog_WindowDeactivated(java.awt.event.WindowEvent event)
	{
        dfdCanvas.setEstado(dfdCanvas.SELECIONAR);
	}
}
