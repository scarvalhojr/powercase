...
public class EditarDepositoDialog extends Dialog
{
    ...
    protected void ok ()
    {
        deposito.setDescricao(textField_descricao.getText());
    }
    public EditarDepositoDialog (Frame parent, Deposito deposito)
    {
        this(parent, true);

        this.deposito = deposito;

        this.setTitle(this.getTitle() + deposito.getDescricao());
        textField_descricao.setText(deposito.getDescricao());

    }
	public EditarDepositoDialog(Frame parent, boolean modal)
	{
		super(parent, modal);
		...
		label1 = new java.awt.Label("Descrição do deposito:");
		label1.setBounds(12,10,133,15);
		add(label1);
	...
	public EditarDepositoDialog(Frame parent, String title, boolean modal)
	{
		this(parent, modal);
		setTitle(title);
	}
	...
	class SymWindow extends java.awt.event.WindowAdapter
	{
		public void windowOpened(java.awt.event.WindowEvent event)
		{
			...
			if (object == EditarDepositoDialog.this)
				EditarDepositoDialog_WindowOpened(event);
		}
	...
	void EditarDepositoDialog_WindowOpened(java.awt.event.WindowEvent event)
	{
        this.abrir();
	}
