...
public class SelecionarDepositoDialog extends Dialog
{
    ...
    protected void excluir ()
    {
        ...
        if (indice == -1) return;
        deposito = this.lista.getDeposito(indice);
        this.lista.remover(indice);
        this.projeto.dfd0.excluirReferenciaElemento(deposito);
    ...
    protected void inserir ()
    {
        ...
        this.lista.adicionar("Novo deposito");
        this.atualizar();
    ...
    protected void editar ()
    {
        ...
        (new EditarDepositoDialog(this.parentFrame, deposito)).setVisible(true);

        this.atualizar();
        list.select(indice);
    }
    protected Frame parentFrame;
    public Deposito selecionada;
    protected void atualizar()
    {
        ...
        deposito = lista.getPrimeiro();
        while (deposito != null)
        {
            list.add(deposito.getDescricao());
            deposito = lista.getProximo();
        }
        list.select(0);

    }
    public SelecionarDepositoDialog (Frame parent, Projeto projeto)
    {
        this(parent, true);
        this.projeto = projeto;
        this.lista = projeto.depositos;
        this.parentFrame = parent;
        this.atualizar();
    }
    protected ListaDepositos lista;
	public SelecionarDepositoDialog(Frame parent, boolean modal)
	{
		super(parent, modal);
	...
	public SelecionarDepositoDialog(Frame parent, String title, boolean modal)
	{
		this(parent, modal);
		setTitle(title);
	}
	...
	class SymWindow extends java.awt.event.WindowAdapter
	{
		public void windowClosing(java.awt.event.WindowEvent event)
		{
			...
			if (object == SelecionarDepositoDialog.this)
    ...
    protected void selecionar ()
    {
        ...
        this.selecionada = lista.getDeposito(indice);
        fechar();
    }
