...
public class EditarEntidadeDialog extends Dialog
{
    ...
    protected void ok ()
    {
        entidade.setDescricao(textField_descricao.getText());
    }
    public EditarEntidadeDialog (Frame parent, Entidade entidade)
    {
        this(parent, true);

        this.entidade = entidade;

        this.setTitle(this.getTitle() + entidade.getDescricao());
        textField_descricao.setText(entidade.getDescricao());

    }
	public EditarEntidadeDialog(Frame parent, boolean modal)
	{
		super(parent, modal);
		...
		label1 = new java.awt.Label("Nome da entidade:");
	...
	public EditarEntidadeDialog(Frame parent, String title, boolean modal)
	{
		this(parent, modal);
		setTitle(title);
	}
	...
	class SymWindow extends java.awt.event.WindowAdapter
	{
		public void windowOpened(java.awt.event.WindowEvent event)
		{
			...
			if (object == EditarEntidadeDialog.this)
				EditarEntidadeDialog_WindowOpened(event);
		}
	...
	void EditarEntidadeDialog_WindowOpened(java.awt.event.WindowEvent event)
	{
        this.abrir();
	}
